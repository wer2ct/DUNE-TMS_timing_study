...
def main():
    ...
    run_train(selected_model, training_data_loader, validation_data_loader, num_iterations = 50000, optimizer='Adam', log_dir = '/sdf/data/neutrino/summer25/ktwall/logs_Bertha', log_prefix= 'delaunay-BerthaStatic-GPU-batch1000-p02')
    #now lets save the weights, we will be doing plotting etc elsewhere. 
    model_weights = selected_model.state_dict()
    torch.save(model_weights, weights_dir + 'delaunay-BerthaStatic-GPU-train90-batch1000-p02.pth')
